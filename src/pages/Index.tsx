            ...
            border: '1px solid rgba(245, 241, 237, 0.1)'
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea id="message" name="message" required placeholder="Tell us what you're looking for..." className="w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 transition-all resize-y" style={{
                  backgroundColor: '#F5F1ED',
                  color: '#2E294E',
                  borderColor: 'rgba(46, 41, 78, 0.2)',
                  minHeight: '120px'
                ...
                {/* Submit Button */}
                <button type="submit" className="w-full h-12 rounded-lg font-bold shadow-lg hover:scale-105 transition-transform" style={{
